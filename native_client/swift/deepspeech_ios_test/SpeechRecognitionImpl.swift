...
class SpeechRecognitionImpl : NSObject, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    override init() {
        let modelPath = Bundle.main.path(forResource: "deepspeech-0.9.3-models", ofType: "tflite")!
        let scorerPath = Bundle.main.path(forResource: "deepspeech-0.9.3-models", ofType: "scorer")!
